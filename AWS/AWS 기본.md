...
`tom`에게 임시 권한을 부여하여 S3 권한을 직접적으로 갖지 않지만 역할을 가정하는 방식


`tom`에게 IAM User로서 신뢰할 수 있는 엔티티 유형을 부여한다.
이때, EC2/ Lamda 같은 서비스에게 부여하게 되면 **AWS 서비스** 엔티티 부여 정책을 선택하여야 한다.

![](../Images/Pasted%20image%2020260909104652.png)
