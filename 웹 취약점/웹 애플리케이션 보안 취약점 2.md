...
```bash
Step 1. 똑같은 APK 파일 디렉토리 하위 begin(), end()가 uinfo, tmp로 끝나는 파일 안에 저장된 것을 추적

a15x:/data/data/jakhar.aseem.diva  ls                   > cache  code_cache  databases  shared_prefs  uinfo3064169690961027081tmp                      

a15x:/data/data/jakhar.aseem.diva  cat uinfo3064169690961027081tmp                       
> mooni:dev
...
**문제 4. Insecure Data Storage - Part 4**



![](../Images/Pasted%20image%2020260804150931.png)

```bash
cd /sdcard/
cat .uinfo.txt
>2026-08-04:veryhotday
```
...
**문제 5. Input Validation Issues - Part 1 & 2**

**Part 1**
특별한 해결법이 필요하지는 않다.
sql injection 문제와 동일하게 'or '1' = '1 대입하면 성공한다.


**Part 2**
editText 값에 도메인 주소를 입력하게 되면 입력한 도메인 주소로 이동 된다.
```
file:///data/data/jakhar.aseem.diva/shared_prefs/jakhar.aseem.diva_preferences.xml
```

![](../Images/Pasted%20image%2020260804152922.png)
...
SSL pinning 우회 기법, frida 등 고급 기법
