...
**공격 방법**
`불충분한 인증 취약점`이 필요하다. 특히 피싱 또는 XSS 취약점을 이용해서 피해자 모르게 웹사이트에 HTTP 요청을 하게 한다.
...
<form method='POST' action='ravine-banked-fanatic.ngrok-free.dev/member/mem_modify_ok.asp' target="csrf-frame" id="csrf-form">
